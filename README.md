...
## Instructions Part E - Deploying to Render

<details>
<summary>Deploying to Render</summary>
<br>

For a general overview of setting up Render view this [Loom video](https://loom.com/share/d2829cd646884658a1bee1e44a4108c8)

1. Sign in to [Render](https://dashboard.render.com/) with your GitHub account
2. Click on the **New +** button
3. Click on **Static Site**
4. In the following screen copy the URL of your project on GitHub (it should look like ` https://github.com/Developers-Institute-Classrooms/01-project---build-a-chatbot-XXXX`) in to the **Public Git repository** field and click **Continue**
5. You may need to connect your GitHub account to Render
6. Authorise your account
7. On the next screen on Render enter the Name as **chat-bot**
8. Set the **Publish directory** as `./Submission`
9. Click the **Create Static Site** button, and you should see a terminal in the browser
10. Once you see the message `Your site is live`, you can then click on the purple link with a URL similar to `https://chat-bot.onrender.com`
11. Save and copy the url for your new website
